<!-- TRIAL BOOTSTRAP STYLE  No longer needed. Used at very beginning -->
<!DOCTYPE html>
<html lang="en">
  <head>
    <meta charset="UTF-8" />
...
<div class="jumbotron bg-light">
  <h1 class="text-center">Welcome to Catalogit</h1>     
  <h1 class="text-center pb-4">Music Library</h1>
  <h3 class=" mb-5 text-center">Will you be searching for a book or a composition?<h3/p>
      ...
      <div class="col ">
        <form action='multipageform2.php' method='post'>
          <div class="text-center">
            <input class="btn btn-secondary" type='submit' value='Composition'/>
...
<div class="container bg-secondary pb-3 ">
   ...
   <h3>Click the radio button to Choose an option below. Then click on the "choose book" button to continue. </h3>
    ...
    if (isset($_POST['bookTitle'])) {
      ...
      <div class="card mb-3" >
        <div class="card-body bg-light ">
            ...
            <br/><input type="radio" name="bookID" value="$bookID" /><div>Book Title: $bookTitle<br>Book Tag 1: $bookTag1<br>Book Tag 2: $bookTag2<br>Book Volume: $bookVolume<br>Book Number: $bookNumber<br>Editor Name: $editorFirstName $editorMiddleName $editorLastName $editorSuffix<br>Publisher Name: $publisherName<br>Publisher Location: $publisherLocation/></div><br><br>
...
if ($BookTitleFound) {
    echo <<<_END
      ...
      <input class="btn"type='submit' value='Choose Book'/>
...
_END;
    ...
    <div class="col-md-4 offset-lg-2 pb-4">
    <form action='multipageform2.php' method='post'>
    ...
    <form action='multipageform2.php' method='post'>
     <div class="button-section">
      <input class="btn btn-secondary mb-3" type='submit' value='Delete this Book'/>
      <input type='hidden' name="next" value='showPage12'/>
     </div>
    </form>
    ...
    <form action='multipageform2.php' method='post'>
     <div class="button-section">
      <input class="btn btn-secondary mb-3" type='submit' value='Find a Composition from this book'/>
